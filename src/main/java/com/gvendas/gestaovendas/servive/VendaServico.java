...
public class VendaServico extends AbstractVendaServico {
	...
	public ClienteVendaResponseDTO atualizar(Long codigoVenda, Long codgioCliente, VendaRequestDTO vendaDto) {
		validarVendaExiste(codigoVenda);
		Cliente cliente = validarClienteVendaExiste(codgioCliente);
		...
		return retornoClienteVendaResponseDTO(vendaAtualizada,
